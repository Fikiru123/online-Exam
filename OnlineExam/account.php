...
<title> align "center" wellcome to unity universty Online Exam System </title>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Alemneh Bayih Unity universty IT Techinial" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Sunny Prakash Tiwari</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">0924524797889</h4>
		<h4 style="font-family:'typo' ">alemnehbayih24@gmail.com</h4>
		<h4 style="font-family:'typo' ">Alemneh Bayih Unity universty IT Techinial ,</h4></div></div>
		</p>
      </div>
