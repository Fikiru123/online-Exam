  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/IMG_20180626_174823.jpg" width=100 height=100 alt="Alemneh Bayih" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Alemneh Bayih</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+251924524797</h4>
		<h4 style="font-family:'typo' ">alexbayih24@gmail.com</h4>
		<h4 style="font-family:'typo' ">Unity universty </h4></div></div>
		</p>
      </div>
