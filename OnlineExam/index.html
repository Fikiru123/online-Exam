...
<title> welcame to Online Exam System </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">  Unity universty Online Exam System</span></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/IMG_20200207_121942.jpg" width=100 height=100 alt="Alemneh Bayih" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Alemneh Bayih</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">0924524797</h4>
		<h4 style="font-family:'typo' ">Alex@gmail.com</h4>
		<h4 style="font-family:'typo' ">unity universty IT techian </h4></div></div>
		</p>
      </div>
